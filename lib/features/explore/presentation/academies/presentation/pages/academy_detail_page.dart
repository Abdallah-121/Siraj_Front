...
class AcademyDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String registrationDates =
        '${context.l10n.sampleRegistrationDateValue}\n${context.l10n.sampleRegistrationDateSecondValue}';
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  DetailTitleSection(
                    title: context.l10n.sampleAcademyTitle,
                    description: context.l10n.sampleAcademyDescription,
                  ),
                  AppGap.v24,
                  PlaceDetailContentCard(
                    ...
                    extraLabel: context.l10n.maximumStudents,
                    extraValue: context.l10n.sampleMaximumStudentsValue,
                    secondExtraLabel: context.l10n.registrationOpenFrom,
                    secondExtraValue: registrationDates,
                    noteLabel: context.l10n.notes,
                    noteValue: context.l10n.sampleNotesValue,
                    centerFooterText: context.l10n.certificateAvailable,
                  ),
                  AppGap.v20,
                  Text(
                  ...
                  RegisterInCourseButton(
                    label: context.l10n.registerInCourse,
